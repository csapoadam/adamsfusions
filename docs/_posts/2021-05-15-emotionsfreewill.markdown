...
Let's not mistake this for free will, though. It is some form of (indirect) agency, but the idea will only occur to you because you have read this blog post. Or any other recently published works in the world pop psychology or self-help literature, which are correct in telling you that it is important to *choose to be around people who are smarter than you*, or to embrace the theory that *good microhabits have compound interest*.
